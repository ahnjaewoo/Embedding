...
const string report_path = "D:\\ÊµÑé\\Report\\Experiment.Embedding\\";
...
const Dataset Dbpedia("Dbpedia", "/home/rudvlf0413/distributedKGE/dbpedia/data/preprocessed_data/nif_text_links_en/", "train.ttl", "dev.ttl", "test.ttl", true);
