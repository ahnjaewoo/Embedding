...
master_worker_epochs = ((10, 100),(20,50))
lr = 0.0015
#ndims = (50, 100)
ndims = (100,)
#precisions = (0, 1)
...
with open("result_anchor_transg.csv", 'w') as result_file:
                    ...
                    for precision in precisions:
                        for anchor_num in anchor_nums:
                            for graph_split_method in graph_split_methods:
                                ...
                                result_file.write(f"{dataset}, {num_worker}, {master_epoch}, {worker_iter}, {ndim}, {precision_names[precision]}, {lr}, {anchor_num}, {graph_split_method}, ")
